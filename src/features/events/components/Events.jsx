...
export const Events = () => {
    const { events, loading, getEvents } = useAdminStore();
                    ...
                    <div key={event._id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300">
                        <div className="h-44 bg-slate-200 relative">
                            ...
                            <div className="absolute top-3 left-3">
                                <span className={`px-3 py-1 rounded-full text-white text-[10px] font-black uppercase shadow-md ${event.isActive ? 'bg-emerald-500' : 'bg-red-500'}`}>
                        ...
                        <div className="p-5">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center text-sm text-gray-600">
                                    ...
                                    <div>
                                        <p className="text-[10px] uppercase font-black text-gray-400 leading-none">Fecha y Hora</p>
                                ...
                                <div className="flex items-center text-sm text-gray-600">
                                    <span className="w-8 h-8 flex items-center justify-center bg-blue-50 rounded-lg mr-3 text-lg">📍</span>
                                    <div>
                                        <p className="text-[10px] uppercase font-black text-gray-400 leading-none">Ubicación / Sucursal</p>
